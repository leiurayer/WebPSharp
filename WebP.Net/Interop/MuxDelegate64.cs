...
namespace WebP.Net.Interop
{
    internal class MuxDelegate64
    {
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate WebPMuxError WebPMuxGetFrame(ref WebPMux mux, UInt64 nth, ref WebPMuxFrameInfo frame);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate WebPMuxError WebPMuxDeleteFrame(ref WebPMux mux, UInt64 nth);
