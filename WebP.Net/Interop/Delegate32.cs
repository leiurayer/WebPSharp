...
namespace WebP.Net.Interop
{
    internal class Delegate32
    {
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPDecodeYUV(IntPtr data, UInt32 data_size, ref int width, ref int height,
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPDecodeRGBAInto(IntPtr data, UInt32 data_size,
            IntPtr output_buffer, UInt32 output_buffer_size, int output_stride);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPDecodeARGBInto(IntPtr data, UInt32 data_size,
          IntPtr output_buffer, UInt32 output_buffer_size, int output_stride);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPDecodeBGRAInto(IntPtr data, UInt32 data_size,
            IntPtr output_buffer, UInt32 output_buffer_size, int output_stride);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPDecodeRGBInto(IntPtr data, UInt32 data_size,
           IntPtr output_buffer, UInt32 output_buffer_size, int output_stride);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPDecodeBGRInto(IntPtr data, UInt32 data_size,
            IntPtr output_buffer, UInt32 output_buffer_size, int output_stride);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPDecodeYUVInto(IntPtr data, UInt32 data_size,
            IntPtr luma, UInt32 luma_size, int luma_stride,
            IntPtr u, UInt32 u_size, int u_stride,
            IntPtr v, UInt32 v_size, int v_stride);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPINewRGB(WEBP_CSP_MODE csp, IntPtr output_buffer, UInt32 output_buffer_size, int output_stride);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPINewYUVA(IntPtr luma, UInt32 luma_size, int luma_stride,
            IntPtr u, UInt32 u_size, int u_stride,
            IntPtr v, UInt32 v_size, int v_stride,
            IntPtr a, UInt32 a_size, int a_stride);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPINewYUV(IntPtr luma, UInt32 luma_size, int luma_stride,
            IntPtr u, UInt32 u_size, int u_stride,
            IntPtr v, UInt32 v_size, int v_stride);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate VP8StatusCode WebPIAppend(ref WebPIDecoder idec, IntPtr data, UInt32 data_size);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate VP8StatusCode WebPIUpdate(ref WebPIDecoder idec, IntPtr data, UInt32 data_size);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate VP8StatusCode WebPGetFeaturesInternal(IntPtr data, UInt32 data_size, ref WebPBitstreamFeatures features, int version);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPIDecode(IntPtr data, UInt32 data_size, ref WebPDecoderConfig config);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate VP8StatusCode WebPDecode(IntPtr data, UInt32 data_size, ref WebPDecoderConfig config);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate UInt32 WebPEncodeRGB(IntPtr rgb,
                                 int width, int height, int stride,
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate UInt32 WebPEncodeBGR(IntPtr bgr,
                           int width, int height, int stride,
                           float quality_factor, IntPtr output);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate UInt32 WebPEncodeRGBA(IntPtr rgba,
                           int width, int height, int stride,
                           float quality_factor, IntPtr output);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate UInt32 WebPEncodeBGRA(IntPtr bgra,
                           int width, int height, int stride,
                           float quality_factor, IntPtr output);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate UInt32 WebPEncodeLosslessRGB(IntPtr rgb,
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate UInt32 WebPEncodeLosslessBGR(IntPtr bgr,
                           int width, int height, int stride, IntPtr output);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate UInt32 WebPEncodeLosslessRGBA(IntPtr rgba,
                           int width, int height, int stride, IntPtr output);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate UInt32 WebPEncodeLosslessBGRA(IntPtr bgra,
                           int width, int height, int stride, IntPtr output);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate int WebPMemoryWrite(IntPtr data, UInt32 data_size, ref WebPPicture picture);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate int WebPPlaneDistortion(IntPtr src, UInt32 src_stride, IntPtr reference, UInt32 ref_stride,
            int width, int height, UInt32 x_step, int type,
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void WebPBlendAlpha(ref WebPPicture pic, UInt32 background_rgb);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPSafeMalloc(UInt64 nmemb, UInt32 size);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPSafeCalloc(UInt64 nmemb, UInt32 size);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr WebPMalloc(UInt32 size);
